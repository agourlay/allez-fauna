...
Start `sbt` and then get into the module by running `project integrationTesting`
- execute `it:test` for the integration tests (The server needs to be started beforehand manually!)
